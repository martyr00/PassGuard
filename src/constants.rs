use crate::error_response::error_responses::{
    ErrorResponse, ErrorResponseElements, ALREADY_REGISTERED_EMAIL_JSON,
    ALREADY_REGISTERED_LOGIN_JSON, ERROR_ALREADY_REGISTERED_STATUS, ERROR_DESCRIPTION_STATUS,
    ERROR_NOT_FOUND_STATUS, ERROR_UNAUTHORIZED_STATUS, ERROR_UNKNOWN_STATUS,
    ERROR_WEAK_LOGIN_STATUS, ERROR_WEAK_PASSWORD_STATUS, ERROR_WRONG_FIRST_NAME_STATUS,
    ERROR_WRONG_LAST_NAME_STATUS, ERROR_WRONG_MAIL_STATUS, ERROR_WRONG_REQUEST_STATUS,
    NOT_FOUND_JSON, UNAUTHORIZED_JSON, UNKNOWN_JSON, WEAK_LOGIN_JSON, WEAK_PASSWORD_JSON,
    WRONG_DESCRIPTION_JSON, WRONG_FIRST_NAME_JSON, WRONG_LAST_NAME_JSON, WRONG_MAIL_JSON,
    WRONG_REQUEST_JSON,
};
